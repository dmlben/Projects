...
public class PoolerTesterServletKiller extends HttpServlet{
	...
	public void doGet(HttpServletRequest request,HttpServletResponse response)throws ServletException, IOException {
		...
		String nb = request.getParameter("nbProcessK");
		...
		for (int i = 0; i < nbThread; i++) {
			...
			listOfTesters[i] = new ConnectionTesterThread(QueryLoader.SQL_KILLER,"SQL_KILLER", response);
